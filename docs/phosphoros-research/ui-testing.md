...
This log extends the [boot investigation](sc64-boot-testing.md) into steady-state
...
Detailed findings and source links: [MCU and SD](sc64-ui-research/mcu.md),
[FPGA and direct GIF](sc64-ui-research/fpga.md),
[N64 rendering and asset transport](sc64-ui-research/ui.md).
The maintained [gap tracker](sc64-gaps.md) records upstream ownership, current
...
The maintained [gap tracker](sc64-gaps.md) now owns the cross-project gap index.
The [selected-register experiment](../vendor/sc64/tests/open-toolchain/area-map/reset-unmap.md)
...
The [compact localization](../vendor/sc64/tests/open-toolchain/area-map/compact-placement.md)
...
The [debugger sample](../vendor/sc64/tests/open-toolchain/area-map/placement-stack.md)
...
The [control-set review](../vendor/sc64/tests/open-toolchain/area-map/control-sets.md)
...
The [compact integration](../vendor/sc64/tests/gif/stock-lzw-fit/compact.md)
...
The [placement diagnosis](../vendor/sc64/tests/open-toolchain/area-map/placement.md)
...
The [arithmetic equivalence gate](../vendor/sc64/tests/open-toolchain/area-map/equivalence.md)
...
The bounded [alternative placer](../vendor/sc64/tests/open-toolchain/area-map/alternative-placement.md)
...
The [LZW-only stock probe](../vendor/sc64/tests/gif/stock-lzw-fit/README.md)
...
The [compact decoder](../vendor/sc64/tests/gif/compact-lzw/README.md) narrows
...
The [mapping comparison](../vendor/sc64/tests/open-toolchain/area-map/README.md)
...
The [MCU/N64 split review](../vendor/sc64/tests/gif/mcu-split/README.md) rejects
...
The [header-counter experiment](../vendor/sc64/tests/gif/header-counter/README.md)
...
All six [compositor arithmetic candidates](../vendor/sc64/tests/gif/compact-compose/README.md)
...
The [four-client MCU mux](../vendor/sc64/tests/gif/transport-mcu/README.md)
...
The [actual-arbiter matrix](../vendor/sc64/tests/gif/transport-fairness/README.md)
...
The [stock-pin integration skeleton](../vendor/sc64/tests/gif/stock-fit/README.md)
...
The parent [phrase-bound gate](../vendor/sc64/tests/gif/phrase-bound/README.md)
...
The [bounded decoder](../vendor/sc64/tests/gif/sc64-bounded/README.md) passes
...
The [explicit-priority mux](../vendor/sc64/tests/gif/transport-mux/README.md)
...
The [combined resource audit](../vendor/sc64/tests/gif/transport-fit/README.md)
...
The [cache-size comparison](../vendor/sc64/tests/gif/cache-budget/README.md)
...
The [RAM timing-pin audit](../vendor/sc64/tests/open-toolchain/timing-data/ebr-arcs/README.md)
...
The [spill-stack experiment](../vendor/sc64/tests/gif/cache-budget/spill.md)
...
The [registered DMA flags](../vendor/sc64/tests/open-toolchain/memory/dma-flags/README.md)
...
[Algebraic inequalities and explicit bitfields](../vendor/sc64/tests/open-toolchain/memory/dma-flags/algebra/README.md)
...
Completed the [project documentation audit](sc64-ui-research/documentation-audit.md):
...
New [exact 7000HC active-RAM evidence](../vendor/sc64/tests/open-toolchain/timing-data/active-7000-evidence.md)
...
[source-aware PIO gate](../vendor/sc64/tests/open-toolchain/pio-evidence/README.md)
...
[Hardware evidence](../vendor/sc64/tests/open-toolchain/constraints/hardware-evidence.md)
...
[Three additional route probes](../vendor/sc64/tests/open-toolchain/memory/timing-options3.md)
...
[timing investigation](../vendor/sc64/tests/open-toolchain/timing-research.md).
...
[timing options](../vendor/sc64/tests/open-toolchain/memory/timing-options.md).
...
[external STA](../vendor/sc64/tests/open-toolchain/constraints/external-sta.md).
...
[configuration and board evidence](../vendor/sc64/tests/open-toolchain/efb/inactive/configuration-research.md).
...
[integration audit](../vendor/sc64/tests/open-toolchain/integration-audit.md).
...
The isolated [open-toolchain probes](../vendor/sc64/tests/open-toolchain/README.md)
...
- The [vanilla-theme audit](sc64-ui-research/vanilla-themes.md) identifies direct
...
The [prototype results](sc64-ui-research/gif-prototype.md) record the full
comparison and remaining integration requirements. Reproducible RTL lives in
`vendor/sc64/tests/gif/`; N64 receiver tools live in `tools/verify/sc64-gif/`.
...
`build/sc64-ui-research/`. Durable harness rows are in [perf_log.md](perf_log.md)
and [perf_log.csv](perf_log.csv), labeled `sc64-ui-production-baseline`.
...
theme archive; [the FPGA note](sc64-ui-research/fpga.md) records source URLs,
...
[per-commit coverage](sc64-ui-research/gif-commit-coverage.md) records fresh
...
research, the prior [documentation inventory](sc64-ui-research/documentation-audit.md),
...
[`vendor/sc64/docs/phosphoros.md`](../vendor/sc64/docs/phosphoros.md) are already
