...
FPGA build and original OS4 GIF playback. The [testing log](sc64-ui-testing.md)
...
the [broader practical improvement review](sc64-ui-testing.md#practical-sc64-and-phosphoros-review--2026-09-06).
...
see the [memory-wait experiment](sc64-boot-testing.md#sdram-dispatch-wait-experiment--2026-09-07).
...
See the [complete measurements](sc64-ui-testing.md#sdusb-overlap-experiments--2026-09-06).
...
[control-set search hook](../vendor/sc64/tests/open-toolchain/area-map/control-set-heuristic.md).
