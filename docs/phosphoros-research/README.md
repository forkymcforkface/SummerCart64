# PhosphorOS hardware research

SummerCart64 owns the FPGA, firmware and toolchain research for PhosphorOS here.

- [Boot experiments](boot-testing.md)
- [UI and GIF experiments](ui-testing.md)
- [Open gaps](gaps.md)
- [Research notes](notes/)
- [GIF receiver harness](../../tests/phosphoros-receiver/README.md)
- [Benchmark records](benchmarks.md) and [CSV](benchmarks.csv)
