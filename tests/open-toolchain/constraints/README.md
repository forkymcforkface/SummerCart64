...
The [board and SDRAM evidence](hardware-evidence.md) checks the external
requirements against the declared ISSI part and preserves the distinction
between board timing, LPF semantics and internal FPGA characterization.
